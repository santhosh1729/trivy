...
func NewCacheProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Cache {
	...
	serviceURL += baseServicePath(clientOpts.PathPrefix(), "trivy.cache.v1", "Cache")
	urls := [3]string{
...
func NewCacheServer(svc Cache, opts ...interface{}) TwirpServer {
	...
	for _, opt := range opts {
		...
		case nil: // backwards compatibility, allow nil value for the argument
			continue
		default:
			panic(fmt.Sprintf("Invalid option type %T on NewCacheServer", o))
		}
	}
...
// CachePathPrefix is a convenience constant that could used to identify URL paths.
