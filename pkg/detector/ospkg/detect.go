...
var (
	...
	drivers = map[ftypes.OSType]Driver{
		...
		ftypes.OpenSUSETumbleweedLegacy: suse.NewScanner(suse.OpenSUSETumbleweed),
		ftypes.OpenSUSELeapLegacy:       suse.NewScanner(suse.OpenSUSE),
		ftypes.SLESLegacy:               suse.NewScanner(suse.SUSEEnterpriseLinux),
		ftypes.SLEMicroLegacy:           suse.NewScanner(suse.SUSEEnterpriseLinuxMicro),
	}
)
